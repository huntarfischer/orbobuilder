...
import { floorTargets, contactTargets, synchronicTargets } from './framing.js';
import { scanTargets, decorate } from './loom.js';

export const LUNA_KINDS = ['ingress', 'syzygy', 'mutual', 'contact', 'synchronic'];
...
export const MAX_SPAN = { ingress: 3700, syzygy: 3700, mutual: 400, contact: 200, synchronic: 200 };
const MEMO_CAP = 24;
const memo = new Map();
export function clearLuna() { memo.clear(); }

const touchesMoon = (t) => t.body === 'Moon' || t.other === 'Moon';

export function lunaTargets(kind, natal, opts = {}) {
...
export function lunaWindow(spec) {
...
export function switchGroups(rows, opts = {}) {
