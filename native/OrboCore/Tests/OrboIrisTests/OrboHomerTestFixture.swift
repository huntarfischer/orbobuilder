...
enum OrboHomerTestFixture {
    static let subjectID = HermesSubjectID(rawValue: "orbo.homer.native-001")!
    static let packageID = HermesPackageID(
        UUID(uuidString: "11111111-2222-3333-4444-555555555555")!
    )
    static let handoffAt = AbsoluteInstant(unixSecondsSince1970: 1_777_000_000)!
    static let hearthNoticeAt = AbsoluteInstant(unixSecondsSince1970: 1_777_000_300)!
