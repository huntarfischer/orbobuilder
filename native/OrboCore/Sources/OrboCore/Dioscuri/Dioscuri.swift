...
public struct Dioscuri: Sendable {
    ...
    public func certify(
        ...
        // Exact relationships. Resume reconstructs the cursor's ambiguity set without Castor
        // reads, then continues at the next untested relationship. Second strikes are direct.
