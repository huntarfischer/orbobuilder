...
import { positions, bodyLon, norm360, wrap180 } from './ephem.js';
import { scanTransitHits, natalTarget, DEFAULT_TRANSIT_BODIES } from './transits.js';

export const SPINE_VERSION = 2; // v2: natal targets grew IC/DSC/Vertex/Fortune (parity with the app's _natalTargets)
// ex-Moon (fast-hand law). SNode already excluded upstream in DEFAULT_TRANSIT_BODIES.
export const SPINE_BODIES = DEFAULT_TRANSIT_BODIES.filter((b) => b !== 'Moon');
...
export const STATION_BODIES = ['Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Chiron'];
...
export const COMP_TARGET_BODIES = ['Sun', 'Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto'];
...
// ── the unspooler ───────────────────────────────────────────────────────────
export function makeUnspooler(dna, opts = {}) {
...
export function buildSpine(dna, opts = {}) {
...
export function spineSlice(events, a, b, filter = null) {
...
export function isReturn(e) { return e.kind === 'hit' && e.a === 0 && e.t === e.g; }
export function isFlip(e) { return e.kind === 'hit' && e.a === 180 && e.t === e.g; } // bead drains channel-end → wells up opposite
