> September 3 Astrolabe Act I repass: visual and selection corrections, removal of native bottom navigation, and single-answer live refresh are implemented; native verification is pending. See `specs/gates/2026-09-03-Astrolabe-Act-I-Repass.md`. Earlier acceptance records below describe their tested commits.
