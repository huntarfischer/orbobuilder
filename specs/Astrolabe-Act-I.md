...
The repass is verified by [run 33782473759](https://github.com/huntarfischer/orbobuilder/actions/runs/33782473759) at `53e7d40`: 943 package tests and 944 Xcode tests (including actual-touch interaction), all passing; both apps built and launched; captures inspected. Debug simulator timings were 194.557 s for sealed-Spine load/assembly, 0.043 s for first sky preparation and 0.802 s for birth/Hearth delivery. Startup optimization remains open. The run used iOS 26.4.1; no pre-26 execution is claimed. See `specs/gates/2026-09-03-Astrolabe-Act-I-Repass.md` for evidence and limits.
