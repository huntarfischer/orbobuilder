// aaf.browser.js — GENERATED from aaf.js (browser-global build, ES exports rewritten,
// attachAstroDNA dropped: the app sequences via its own AstroDNA gateway). Regenerate
// from aaf.js on change; never hand-edit (see CLAUDE.md).
(function () {
...
function toJD(y, mo, d, h, mi, sec, utcOffset, calendar) {
...
window.__ORBO_AAF = { parseAAF, toJD };
})();
