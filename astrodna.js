...
import { positions, angles, norm360, wrap180, vertex } from './ephem.js';
...
import { MARKS, separation, arcOf, ARCSEC, arcsecOf, fineStateOf, stateOfFine } from './ring.js';
...
import { SIGNS, SIGN_ELEMENTS, DOMICILE } from './mater.js';
...
export const SIGN_RULERS = DOMICILE;
...
export const NODE_ORDER = ['Ascendant', 'Moon', 'Sun', 'Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Node'];
export const PRIMARY_NODES = ['Ascendant', 'Moon', 'Sun']; // reordered to match, so "the first three" stays true positionally
...
export const SEQ_CODEC = 3;
export const RETROGRADE_CAPABLE = ['Mercury', 'Venus', 'Mars', 'Jupiter', 'Saturn', 'Uranus', 'Neptune', 'Pluto', 'Node'];
...
export const LOTS = ['Fortune', 'Spirit', 'Eros', 'Necessity', 'Courage', 'Victory', 'Nemesis', 'Death'];
export function lots(ascLon, isDay, pos) {
...
export function buildAstroDNA(jdUT, lat, lon) {
...
export function sequenceString(dna) {
...
export function degreeSequenceString(dna) {
