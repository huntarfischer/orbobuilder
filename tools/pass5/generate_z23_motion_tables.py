...
def main():
    ...
    manifest={
      'zeitgeist':'Z23','artifactFamily':'Orbo motion tables',
      'ownershipLaw':'Z23 first Pluto Aries ingress inclusive to Z24 first Pluto Aries ingress exclusive',
      'startJulianDayUT':START,'startUTC':'2066-06-17T15:24:10.695Z','endJulianDayUT':END,'endUTC':'2311-06-10T14:16:12.881Z',
    ...
    print('PASS Z23 focused motion manufacture')
